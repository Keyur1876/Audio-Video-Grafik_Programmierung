...
// MCIBeleg.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CMCIBelegApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMCIBelegApp-Erstellung

CMCIBelegApp::CMCIBelegApp()
{
...
// Das einzige CMCIBelegApp-Objekt

CMCIBelegApp theApp;


// CMCIBelegApp-Initialisierung

BOOL CMCIBelegApp::InitInstance()
{
